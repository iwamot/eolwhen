...
// evidence words how one row was arrived at: the version read from the
// line, the cycle it reached, how its name was answered, and where the day
// came from. A row is a claim about somebody else's software, worked out
// through a name table, a purl, a codename or an ordering of cycles, and
// this is what lets a reader take the claim apart instead of taking it on
// trust. The page at the end is where to check it.
